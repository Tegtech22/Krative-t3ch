...
async function initDb() {
  ...
  await pool.query(`
    ...
    ALTER TABLE enrollments DROP CONSTRAINT IF EXISTS enrollments_progress_check;
    ALTER TABLE enrollments ADD CONSTRAINT enrollments_progress_check CHECK (progress BETWEEN 0 AND 100);
